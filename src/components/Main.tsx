...
export default function Main() {
  return (
    <main className="text-white uppercase w-[70%] mx-auto flex justify-between items-center mt-[7rem] tab-port:flex-col tab-port:gap-[4rem] tab-port:py-[2rem] tab-port:mt-0">
